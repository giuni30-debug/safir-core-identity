...
const ro: Record<keyof typeof en, string> = {
  ...
  offline: "Offline",
  typing: "scrie",
  lastSeenJustNow: "văzut acum",
  lastSeenPrefix: "văzut acum",
  minutesAgo: "min",
  hoursAgo: "h",
  daysAgo: "z",
  statusSent: "Trimis",
  ...
  commTitle: "Comunicare rapidă",
  commChat: "Chat",
  commCall: "Sună",
  commVideo: "Video",
  commChatDesc: "Mesaje în timp real",
  commCallDesc: "Sună instant",
  commVideoDesc: "Video live HD",
  commOnlineNow: "Online acum",
  commQuickContacts: "Contacte rapide",
  commNoContactsYet: "Adaugă primul contact",
  aiTitle: "All Assist AI",
...
const tr: Record<keyof typeof en, string> = {
  ...
  offline: "Çevrimdışı",
  typing: "yazıyor",
  lastSeenJustNow: "az önce görüldü",
  lastSeenPrefix: "son görülme",
  minutesAgo: "dk önce",
  hoursAgo: "sa önce",
  daysAgo: "gün önce",
  statusSent: "Gönderildi",
  statusDelivered: "İletildi",
  statusSeen: "Görüldü",
  seenAt: "Görüldü",
  // Sounds & Haptics
  soundsTitle: "Sesler ve Titreşim",
  soundsSubtitle: "Uygulama genelinde premium ses geri bildirimi",
  soundEnabled: "Sesler",
  hapticsEnabled: "Titreşim",
  volume: "Ses seviyesi",
  ...
  commTitle: "Hızlı iletişim",
  commChat: "Sohbet",
  commCall: "Ara",
  commVideo: "Video",
  commChatDesc: "Anlık mesajlaşma",
  commCallDesc: "Anında ara",
  commVideoDesc: "Canlı HD video",
  commOnlineNow: "Şimdi çevrimiçi",
  commQuickContacts: "Hızlı kişiler",
  commNoContactsYet: "İlk kişini ekle",
  aiTitle: "All Assist AI",
...
const de: Record<keyof typeof en, string> = {
  ...
  offline: "Offline",
  typing: "schreibt",
  lastSeenJustNow: "gerade gesehen",
  lastSeenPrefix: "zuletzt gesehen vor",
  minutesAgo: "Min.",
  hoursAgo: "Std.",
  daysAgo: "T.",
  statusSent: "Gesendet",
  ...
  seenAt: "Gesehen um",
  // Sounds & Haptics
  soundsTitle: "Töne & Vibration",
  soundsSubtitle: "Premium-Audio-Feedback in der gesamten App",
  soundEnabled: "Töne",
  hapticsEnabled: "Vibration",
  volume: "Lautstärke",
  ...
  commTitle: "Schnelle Kommunikation",
  commChat: "Chat",
  commCall: "Anruf",
  commVideo: "Video",
  commChatDesc: "Echtzeit-Nachrichten",
  commCallDesc: "Sofort anrufen",
  commVideoDesc: "Live HD-Video",
  commOnlineNow: "Jetzt online",
  commQuickContacts: "Schnellkontakte",
  commNoContactsYet: "Ersten Kontakt hinzufügen",
  aiTitle: "All Assist AI",
